                    ...
                    <div>
                        <div className='text-xl mt-9'>
                            ...
                            <ul className='list-disc text-sm md:text-xl '>
                                ...
                                <li className='mt-3'>🎓I’m in 3rd year pursuing B.E. in Information technology from University of Mumbai. I am always excited to learn new things, meet new people ,get connected with like minded people , share my experience, and learn from their experiences.</li>

                                <li className='mt-3'>💻I have experience working in languages and technologies such as ,ReactJs , JavaScript, Python, HTML, CSS , Firebase and Java I am proficient with Git and GitHub and I am learning DSA with JAVA.
                                </li>
